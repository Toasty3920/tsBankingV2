Config = {}
Config.Locale = 'de' -- Change translation file here, either en or de
...
Config.AccountnumberPrefix = "TS"

-- Change Accountnumber Settings:
Config.AccountNumberChangeCost = 10000

-- Open atm menu animation settings:
Config.Animation     = true -- If set to false, no animation will be executed if E is pressed
Config.Animationtime = 3000 -- Define the length of time the animation will take

-- Set the position of the ATMs:
Config.BankPositions = {
    coords = {
        vector3( 89.75, 2.35, 68.31),
        vector3( 1167.02, -456.32, 66.79),
        vector3( -386.733, 6045.953, 31.501),
        vector3( -205.9134, -1327.7191, 30.8904),
        ...
        vector3( 141.1793, -762.7404, 242.1520),
